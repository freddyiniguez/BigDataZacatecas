...
# Aditionally, if you have issues installing or configuring packages, and if you are working on Mac OS, you can typed:
# defaults write org.R-project.R force.LANG en_US.UTF-8
# on Terminal and then reboot R or R Studio.
